         ...
         <div class="border-0 card">
            ...
            <div class="p-0 card-body">
                ...
                <div class="mb-3 d-block">
                    <form action="{{ route('investment.trash') }}" method="POST">
                        @csrf
                        ...
                        <div class="table-responsive">
                            <table class="table custom-table table-hover">
                                ...
                                <tbody>
                                    @forelse($records as $key => $investment)
                                        <tr>
                                            <th scope="row" class="p-0">
                                                <label class="p-2 d-block">
                                                    <input type="checkbox" name="records[]" value="{{ $investment->id }}" class="me-2">
                                            ...
                                            <td class="print-none text-end">
                                                <a href="{{ route('investment.restore', $investment->id) }}" class="btn table-small-button text-success" title="Restore">
                                                    <i class="bi bi-bootstrap-reboot"></i>
                                                </a>

                                                <a href="{{ route('investment.permanentDelete', $investment->id) }}" onclick="return confirm('Are you sure, want to delete this data permanently?')" title="Permanent delete" class="btn table-small-button text-danger">
