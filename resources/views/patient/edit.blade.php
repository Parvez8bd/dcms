            ...
            <div class="p-0 pt-3 card-body">
                <form action="{{ route('investment.update', $investment->id) }}" method="POST">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-2">
                            <input type="date" name="investment_date" value="{{ old('investment_date', $investment->investment_date) }}" class="form-control" id="investment-date" required>
                    ...
                    <div class="mb-3 row">
                        <div class="col-md-2">
                            <label for="contact-id" class="mt-1 form-label required">Investor & Nominee</label>
                        </div>
