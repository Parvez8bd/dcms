    ...
    <div class="container">
        ...
        <div class="border-0 card">
            <div class="p-0 mt-4 mb-3 border-0 card-header d-flex">
                <!-- page title -->
                <div>
                    <h4 class="main-title">Update Test Group</h4>
                    <p><small>Can Update <strong>Test Group</strong> from here.</small></p>
                </div>
            ...
            <div class="p-0 pt-3 card-body">
                <form action="{{ route('test-group.update',$record->id) }}" method="POST">
                    @csrf
                    @method('PATCH')
