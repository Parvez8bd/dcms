    ...
    <div class="container">
        ...
        <div class="border-0 card">
            ...
            <div class="p-0 mt-4 mb-3 border-0 card-header d-md-flex align-items-center d-block">
                ...
                <!-- refresh -->
                <a href="{{ route('withdraw.index') }}" class="btn top-icon-button print-none" title="Refresh">
                ...
                <!-- add -->
                <a href="{{ route('withdraw.create') }}" class="btn top-icon-button print-none" title="New investment">
            ...
            <div class="p-0 card-body">
                ...
                <div class="mb-3 table-responsive">
                    <table class="table custom-table table-hover">
                        ...
                        <tbody>
                            @forelse($withdraws as $key => $profitDistribution)
                            
                                <tr>
                                    <th scope="row">{{ $withdraws->firstItem() + $key }}.</th>
                                    <td>{{ $profitDistribution->contact->owner_name?? '' ?? ''}}</td>
                                    <td>{{ $profitDistribution->withdraw_date }}</td>
                                    <td >{{ $profitDistribution->note }}</td>
                                    ...
                                    <td class="print-none text-end">
                                            ...
                                            {{-- <a href="{{ route('profit-distribution.show', $profitDistribution->id) }}" class="btn table-small-button" title="View" target="_blank"><i class="bi bi-eye"></i>
                                                ...
                                                <a href="{{ route('withdraw.edit', $profitDistribution->id) }}" class="btn table-small-button text-success" title="Update"><i class="bi bi-pencil-square"></i>
                                            </a> 
                                            ...
                                            <form action="{{ route('withdraw.destroy', $profitDistribution->id) }}" method="post" class="d-none" id="profit-distribution-delete-{{ $profitDistribution->id }}">
                                                @csrf
                                                @method('DELETE')
                                            </form>
