            ...
            <div class="p-0 pt-3 card-body">
                <form action="{{ route('withdraw.update',$withdraw->id ) }}" method="POST">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-2">
                            <input type="date" name="withdraw_date" value="{{ old('investment_date', $withdraw->withdraw_date->format('Y-m-d')) }}" class="form-control" id="investment-date" required>
                        ...
                        <div class="col-md-4">
                            <select name="contact_id" class="form-control select2" id="contact-id" required>
                                ...
                                @foreach ($contacts as $contact)
                                    <option value="{{ $contact->id }}" {{ (old('contact_id',$withdraw->contact_id) == $contact->id) ? 'selected' : ''}}>{{ $contact->owner_name?? '' }} ({{ $contact->organigation_name }})</option>
                                @endforeach
                            </select>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                <input type="number" name="amount" value="{{ old('amount',$withdraw->amount) }}" step="any" min="0" class="form-control" id="investment-amount" placeholder="0.00" aria-describedby="amount-addon" required>
                    ...
                    <div class="mb-5 row">
                        ...
                        <div class="col-md-6">
                            <textarea name="note" class="form-control" id="note" rows="3" placeholder="Optional">{{ old('note',$withdraw->note) }}</textarea>
                        </div>
                    </div>
