    ...
    <div class="container">
        ...
        <div class="border-0 card">
            <div class="p-0 mt-4 mb-3 border-0 card-header d-flex">
                <!-- page title -->
                <div>
                    <h4 class="main-title">Update Contact</h4>
                    <p><small>Update form can bring (something new) into existence.</small></p>
                </div>
                        ...
                        <div class="col-3">
                            <select name="contact_type" class="form-control" id="contact-type" required>
                                ...
                                @foreach (config('utilities.contact') as $contactType)
                                    <option value="{{ $contactType }}" {{ (old('contact_type', $contact->contact_type) == $contactType) ? 'selected' : '' }}>{{ $contactType }}</option>
                                @endforeach
                            </select>
