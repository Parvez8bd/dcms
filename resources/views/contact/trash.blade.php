        ...
        <!-- container menu end -->
         ...
         <div class="border-0 card">
            <div class="p-0 mt-4 mb-3 border-0 card-header d-md-flex align-items-center d-block">
                ...
                <!-- refresh -->
                <a href="{{ route('contact.trash') }}" data-bs-toggle="tooltip" data-bs-placement="bottom" class="btn top-icon-button ms-auto print-none" title="Refresh">
                    <i class="bi bi-arrow-clockwise"></i>
                </a>

                <!-- add -->
                <a href="{{ route('contact.create') }}" class="btn top-icon-button print-none" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Create new project">
                    ...
                    <form action="{{ route('contact.trash') }}" method="POST">
                        ...
                        <div class="table-responsive">
                            <table class="table custom-table table-hover">
                                ...
                                <tbody>
                                    @forelse($records as $key => $contact)
                                        <tr>
                                            <th scope="row" class="p-0">
                                                <label class="p-2 d-block">
                                                    <input type="checkbox" name="records[]" value="{{ $contact->id }}" class="me-2">
