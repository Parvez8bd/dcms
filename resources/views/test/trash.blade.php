                                    ...
                                    @forelse($records as $key => $record)
                                        <tr>
                                            ...
                                            <td class="print-none text-end">
                                                <a href="{{ route('test.restore', $record->id) }}" class="btn btn-success table-small-button" title="Restore">
                                                    <i class="bi bi-bootstrap-reboot"></i>
                                                </a>

                                                <a href="{{ route('test.permanentDelete', $record->id) }}" onclick="return confirm('Are you sure, want to delete this data permanently?')" title="Permanent delete" class="btn table-small-button text-danger">
