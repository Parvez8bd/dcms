        ...
        <div class="border-0 card">
            <div class="p-0 mt-4 mb-3 border-0 card-header d-flex">
                ...
                <div>
                    ...
                    <p><small>Can update <strong>Extra Income </strong>  amount from here.</small></p>
                </div>
            ...
            <div class="p-0 pt-3 card-body">
                <form action="{{ route('income.update',$income->id ) }}" method="POST">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-2">
                            <input type="date" name="income_date" value="{{ old('income_date',$income->income_date->format('Y-m-d')) }}" class="form-control" id="Income-date" required>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                            <input type="text" name="income_sourse" value="{{ old('income_sourse',$income->income_sourse) }}"  class="form-control " placeholder="Like: Newspaper sale, Old furniture sale">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                <input type="number" name="amount" value="{{ old('amount',$income->amount) }}" step="any" min="0" class="form-control" id="Income-amount" placeholder="0.00" aria-describedby="amount-addon" required>
                    ...
                    <div class="mb-5 row">
                        ...
                        <div class="col-md-6">
                            <textarea name="note" class="form-control" id="note" rows="3" placeholder="Optional">{{ old('note',$income->note) }}</textarea>
                        </div>
                    </div>
