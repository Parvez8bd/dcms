            ...
            <div class="p-0 pt-3 card-body">
                <form action="{{ route('investment.store') }}" method="POST">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-2">
                            <input type="date" name="investment_date" value="{{ old('investment_date', date('Y-m-d')) }}" class="form-control" id="investment-date" required>
                        ...
                        <div class="col-md-3">
                            <select name="project_id" class="form-control" id="project-id" required>
                                ...
                                @foreach ($projects as $project)
                                    <option value="{{ $project->id }}">{{ $project->title }} ({{ number_format($project->budget, 2) }})</option>
                                @endforeach
                            </select>
                    ...
                    {{-- <div class="mb-3 row">
                        <div class="col-md-2">
                            <label for="investment-duration" class="mt-1 form-label ">Duration </label>
                        </div>

                        <div class="col-md-2">
                            <div class="input-group">
                                <select name="duration" class="form-control" id="withdraw-policy" aria-describedby="withdraw-addon" >
                                    <option value="" selected disabled>-- </option>
                    ...
                    {{-- <div class="mb-3 row">
                        <div class="col-md-2">
                            <label for="investment-interest" class="mt-1 form-label ">Interest (%)</label>
                        </div>

                        <div class="col-md-3">
                            <div class="input-group">
                                <input type="number" name="interest" value="{{ old('interest', 1) }}" step="any" min="1" max="100" class="form-control" id="investment-interest" placeholder="0%" aria-describedby="interest-addon" >
