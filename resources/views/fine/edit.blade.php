    ...
    <div class="container">
        ...
        <div class="border-0 card">
            <div class="p-0 mb-3 border-0 card-header d-flex">
                <!-- page title -->
                <div class="mt-3">
                    <h4 class="main-title">Edit Fine Withdraw</h4>
            ...
            <div class="p-0 pt-3 card-body">
                <form action="{{ route('fine.update',$fine->id) }}" method="POST">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-2">
                            <input type="date" name="date" value="{{ old('investment_date', $fine->date->format('Y-m-d')) }}" class="form-control" id="investment-date" required autofocus>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                <input readonly type="number" name="fine_amount" value="{{ $fine->fine_amount }}" step="any" min="0" class="form-control" id="fine_amount" placeholder="0.00" aria-describedby="amount-addon" >
                                <span class="input-group-text" id="amount-addon">balance: {{  number_format($totalFine,2) }}</span>
                            </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                <input type="number" name="withdraw_amount" value="{{ old('withdraw_amount',$fine->withdraw_amount) }}" step="any" min="0" class="form-control" id="investment-amount" placeholder="0.00" aria-describedby="amount-addon" required>
                    ...
                    <div class="mb-5 row">
                        ...
                        <div class="col-md-6">
                            <textarea name="note" class="form-control" id="note" rows="3" placeholder="Optional">{{ old('note',$fine->note) }}</textarea>
                        </div>
                    </div>
