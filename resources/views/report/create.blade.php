    ...
    <div class="container">
        ...
        <div class="border-0 card">
            <div class="p-0 mt-4 mb-3 border-0 card-header d-flex">
                <!-- page title -->
                <div>
                    <h4 class="main-title">Create new Report</h4>
                    <p><small>Can create <strong>Report </strong> from here.</small></p>
                </div>
            ...
            <div class="p-0 pt-3 card-body">
                <form action="{{ route('report.store') }}" method="POST">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-9">
                            <textarea name="report"  class="form-control" id="editor" rows="3" placeholder="Optional">{{ old('report') }}</textarea>
                        </div>
                    </div>
