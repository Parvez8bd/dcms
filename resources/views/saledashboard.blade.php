<x-app-layout>
    ...
    <div class="container">
        <div class="text-center mt-3 mb-3">
            <h3 class="">Welcom to Sales-Loan</h3>
        </div>
         <div>
            <h3 class="text-muted mb-2"> Sales <i class="bi bi-cart-check"></i></h3>
        </div>
					...
					<div class="card-body">
						{{-- <a href="{{route('student.index')}}" target="_blank"> --}}
							<div class="row align-items-center">
								<div class="col">
									<h6 class="mb-3 text-white">Total Sale</h6>
										<h3 class="mb-0 text-white">{{ number_format($sale_price,2) }}</h3>
								</div>
				...
				<div class="shadow card payment-card">
					<div class="card-body">
						{{-- <a href="{{route('student.index')}}" target="_blank"> --}}
							<div class="row align-items-center">
								<div class="col">
									<h6 class="mb-3 text-white">Today Sale</h6>
										<h3 class="mb-0 text-white">{{ number_format($daily_sale?? '0.00' ,2) }}</h3>
								</div>
								<div class="col-auto text-white fs-3">
									<i class="bi bi-wallet2"></i>
								</div>
							</div>
								<p class="mt-2 text-white">Total Sales</p>
						</a>
					</div>
				</div>
			</div>
							...
							<div class="row align-items-center">
								<div class="col">
									<h6 class="mb-3 text-white">Last Month</h6>
										<h3 class="mb-0 text-white">{{ number_format($lastMonth_sale,2) }}</h3>
								</div>
								<div class="col-auto text-white fs-3">
				...
				<div class="shadow card expance-color">
					<div class="card-body">
						{{-- <a href="{{route('payment.index')}}" target="_blank"> --}}
							<div class="row align-items-center">
								<div class="col">
									<h6 class="mb-3 text-white">Total Profit </h6>
										<h3 class="mb-0 text-white">{{ number_format($total_profit,2) }}</h3>
								</div>
								<div class="col-auto text-white fs-3">
									<i class="bi bi-credit-card-2-back"></i>
								</div>
							</div>
								<p class="mt-2 text-white">Total Amount</p>
						</a>
					</div>
				</div>
			</div>
	...
	<div class="container">
        <div>
            <h3 class="text-muted mb-2">Installment <i class="bi bi-currency-exchange"></i></h3>
        </div>
        <div class="mb-4 gy-3 row">
           <div class="col-xl-3 col-md-6">
				<div class="shadow card total-color">
					<div class="card-body">
						{{-- <a href="{{route('expense.index')}}" target="_blank"> --}}
							<div class="row align-items-center">
								<div class="col">
									<h6 class="mb-3 text-white">Total Installment</h6>
										<h3 class="mb-0 text-white">{{ number_format($total_installment,2)}}</h3>
								</div>
								<div class="col-auto text-white fs-3 ">
				...
				<div class="shadow card student-card">
					<div class="card-body">
						{{-- <a href="{{route('expense.index')}}?search=1&form_date={{date('Y-m-d')}}&to_date={{date('Y-m-d')}}" target="_blank"> --}}
							<div class="row align-items-center">
								<div class="col">
									<h6 class="mb-3 text-white">Today Installment</h6>
										<h3 class="mb-0 text-white">{{ number_format($daily_installment,2)}}</h3>
								</div>
								<div class="col-auto text-white fs-3">
									<i class="bi bi-cash"></i>
								</div>
					...
					<div class="card-body">
						{{-- <a href="{{route('expense-subcategory.index')}}" target="_blank"> --}}
							<div class="row align-items-center">
								<div class="col">
									<h6 class="mb-3 text-white">Last Month</h6>
										<h3 class="mb-0 text-white">{{ number_format($lastMonth_installment,2)}}</h3>
								</div>
								<div class="col-auto text-white fs-3">
									<i class="bi bi-cash"></i>
								</div>
							</div>
								<p class="mt-2 text-white">Total Installment</p>
						</a>
					</div>
				</div>
			</div>
	...
	<div class="container">
        <div>
            <h3 class="text-muted mb-2">Fine <i class="bi bi-coin"></i></h3>
        </div>
        <div class="mb-4 gy-3 row">
           <div class="col-xl-3 col-md-6">
				<div class="shadow card total-color">
					<div class="card-body">
						{{-- <a href="{{route('expense.index')}}" target="_blank"> --}}
							<div class="row align-items-center">
								<div class="col">
									<h6 class="mb-3 text-white">Total Fine</h6>
										<h3 class="mb-0 text-white">{{ number_format($total_fine,2)}}</h3>
								</div>
								<div class="col-auto text-white fs-3 ">
									<i class="bi bi-cash"></i>
								</div>
				...
				<div class="shadow card student-card">
					<div class="card-body">
						{{-- <a href="{{route('expense.index')}}?search=1&form_date={{date('Y-m-d')}}&to_date={{date('Y-m-d')}}" target="_blank"> --}}
							<div class="row align-items-center">
								<div class="col">
									<h6 class="mb-3 text-white">Total Withdraw</h6>
										<h3 class="mb-0 text-white">{{ number_format($total_withdraw, 2)}}</h3>
								</div>
								<div class="col-auto text-white fs-3">
									<i class="bi bi-cash"></i>
								</div>
							</div>
								<p class="mt-2 text-white">Fine</p>
						</a>
					</div>
				</div>
			</div>
					...
					<div class="card-body">
						{{-- <a href="{{route('expense-subcategory.index')}}" target="_blank"> --}}
							<div class="row align-items-center">
								<div class="col">
									<h6 class="mb-3 text-white">Last Month</h6>
										<h3 class="mb-0 text-white">{{ number_format($lastMonth_fine,2)}}</h3>
								</div>
								<div class="col-auto text-white fs-3">
									<i class="bi bi-cash"></i>
								</div>
							</div>
								<p class="mt-2 text-white">Total Fine</p>
						</a>
					</div>
				</div>
			</div>
					...
					<div class="card-body">
						{{-- <a href="{{route('expense-subcategory.index')}}" target="_blank"> --}}
							<div class="row align-items-center">
								<div class="col">
									<h6 class="mb-3 text-white">Last Month</h6>
										<h3 class="mb-0 text-white">{{ number_format($lastMonth_withdraw,2)}}</h3>
								</div>
								<div class="col-auto text-white fs-3">
									<i class="bi bi-cash"></i>
								</div>
							</div>
								<p class="mt-2 text-white">Total Withdraw</p>
						</a>
					</div>
				</div>
			</div>
