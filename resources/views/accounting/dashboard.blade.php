<x-app-layout>
    ...
    <div class="container">
        <div class="text-center mt-3 mb-3">
            <h3 class="">Welcom to Accounting</h3>
        </div>
         <div>
            <h3 class="text-muted mb-2"> Amount <i class="bi bi-wallet"></i></h3>
        </div>
					...
					<div class="card-body">
						{{-- <a href="{{route('student.index')}}" target="_blank"> --}}
							<div class="row align-items-center">
								<div class="col">
									<h6 class="mb-3 text-white">Total Investment</h6>
										<h3 class="mb-0 text-white">{{ number_format($total_invest,2) }}</h3>
								</div>
				...
				<div class="shadow card payment-card">
					<div class="card-body">
						{{-- <a href="{{route('student.index')}}" target="_blank"> --}}
							<div class="row align-items-center">
								<div class="col">
									<h6 class="mb-3 text-white">Current Cash</h6>
										<h3 class="mb-0 text-white">{{ number_format($cash,2) }}</h3>
								</div>
								<div class="col-auto text-white fs-3">
    ...
    <div class="container">
         ...
         <div>
            <h3 class="text-muted mb-2"> Expenes <i class="bi bi-wallet2"></i></h3>
        </div>
				...
				<div class="shadow card total-color">
					<div class="card-body">
						{{-- <a href="{{route('student.index')}}" target="_blank"> --}}
							<div class="row align-items-center">
								<div class="col">
									<h6 class="mb-3 text-white">Total Expenes</h6>
										<h3 class="mb-0 text-white">{{ number_format($total_expenes,2) }}</h3>
								</div>
								<div class="col-auto text-white fs-3">
									<i class="bi bi-cash-stack"></i>
								</div>
				...
				<div class="shadow card danger">
					<div class="card-body">
						{{-- <a href="{{route('student.index')}}" target="_blank"> --}}
							<div class="row align-items-center">
								<div class="col">
									<h6 class="mb-3 text-white">Today Expenes</h6>
										<h3 class="mb-0 text-white">{{ number_format($today_expenes,2) }}</h3>
								</div>
								<div class="col-auto text-white fs-3">
									<i class="bi bi-wallet2"></i>
								</div>
							</div>
								<p class="mt-2 text-white">Total Expenes</p>
						</a>
					</div>
				</div>
			</div>
				...
				<div class="shadow card payment-card">
					<div class="card-body">
						{{-- <a href="{{route('student.index')}}" target="_blank"> --}}
							<div class="row align-items-center">
								<div class="col">
									<h6 class="mb-3 text-white">Last Expenes</h6>
										<h3 class="mb-0 text-white">{{ number_format($lastMonth_expenes) }}</h3>
								</div>
								<div class="col-auto text-white fs-3">
									<i class="bi bi-credit-card-2-front"></i>
								</div>
				...
				<div class="shadow card expance-color">
					<div class="card-body">
						{{-- <a href="{{route('payment.index')}}" target="_blank"> --}}
							<div class="row align-items-center">
								<div class="col">
									<h6 class="mb-3 text-white">Last Month Expenes </h6>
										<h3 class="mb-0 text-white">{{ number_format($lastMonth_expenes,2) }}</h3>
								</div>
								<div class="col-auto text-white fs-3">
									<i class="bi bi-credit-card-2-back"></i>
								</div>
