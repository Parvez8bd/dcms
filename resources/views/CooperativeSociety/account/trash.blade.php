        ...
        <!-- container menu end -->
         ...
         <div class="border-0 card">
            <div class="p-0 mt-4 mb-3 border-0 card-header d-md-flex align-items-center d-block">
                ...
                <!-- refresh -->
                <a href="{{ route('account.trash') }}" data-bs-toggle="tooltip" data-bs-placement="bottom" class="btn top-icon-button ms-auto print-none" title="Refresh">
                    <i class="bi bi-arrow-clockwise"></i>
                </a>

                <!-- add -->
                <a href="{{ route('account.create') }}" class="btn top-icon-button print-none" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Create new account">
            ...
            <div class="p-0 card-body">
                ...
                <div class="mb-3 d-block">
                    <form action="{{ route('account.trash') }}" method="POST">
                        @csrf
                        ...
                        <div class="table-responsive">
                            <table class="table custom-table table-hover">
                                ...
                                <tbody>
                                    @forelse($records as $key => $account)
                                        <tr>
                                            <th scope="row" class="p-0">
                                                <label class="p-2 d-block">
                                                    <input type="checkbox" name="records[]" value="{{ $account->id }}" class="me-2">
                                            ...
                                            <td class="print-none text-end">
                                                <a href="{{ route('account.restore', $account->id) }}" class="btn btn-success table-small-button " title="Restore">
                                                    <i class="bi bi-bootstrap-reboot"></i>
                                                </a>

                                                <a href="{{ route('account.permanentDelete', $account->id) }}" onclick="return confirm('Are you sure, want to delete this data permanently?')" title="Permanent delete" class="btn table-small-button text-danger">
