            ...
            <div class="p-0 pt-3 card-body">
                <form action="{{ route('account.store') }}" method="POST">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                            {{-- <select name="contacts_id" class="form-control" id="contacts_id" required>
                                <option value="" selected disabled>---</option>
                                @foreach ($contacts as $contact)
                                    <option value="{{ $contact->id }}" {{ (old('contacts_id') == $contact->id) ? 'selected' : '' }}>{{ $contact->owner_name?? '' }}</option>
                                @endforeach
                            </select>  
                                       --}}
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-3">
                            <a href="{{ route('contact.create') }}" class="mt-2" target="_blank">Add Nomine</a>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                <input type="date" name="opening_date" value="{{old('opening_date', date('Y-m-d'))}}" class="form-control" required>
                            </div>
