        ...
        <div class="border-0 card">
            ...
            <div class="p-0 mt-4 mb-3 border-0 card-header d-md-flex align-items-center d-block">
                ...
                <div>
                    ...
                    <p><small>About {{ $subcategories->total() }} results found.</small></p>
                </div>
                ...
                <!-- refresh -->
                <a href="{{ route('sub-category.index') }}" class="btn top-icon-button print-none" title="Refresh">
                ...
                <!-- add -->
                <a href="{{ route('sub-category.create') }}" class="btn top-icon-button print-none" title="Create new category">
            ...
            <div class="p-0 card-body">
                        ...
                        <form action="{{ route('sub-category.index') }}" method="GET">
                            ...
                            <div class="row gy-1 gx-3">
                                <div class="col-12 col-sm-6 col-lg-3">
                                    <label for="project-title" class="form-label">sub category Title</label>
                ...
                <div class="mb-3 table-responsive">
                    <table class="table custom-table table-hover">
                        ...
                        <tbody>
                            @forelse($subcategories as $key => $record)
                                <tr>
                                    ...
                                    <td class="print-none text-end">
                                        ...
                                        <a href="{{ route('sub-category.edit', $record->id) }}" class="btn table-small-button text-success" title="Update"><i class="bi bi-pencil-square"></i>
                                        </a>
                                        ...
                                        <form action="{{ route('sub-category.destroy', $record->id) }}" method="post" class="d-none" id="category-delete-{{ $record->id }}">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                    </td>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th class="text-end">{{ number_format($$subcategories->sum('budget'), 2) }}</th>
                                <th>&nbsp;</th>
                            </tr>
                        </tfoot>
                        @endif --}}
