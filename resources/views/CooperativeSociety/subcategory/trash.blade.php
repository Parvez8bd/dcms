        ...
        <!-- container menu end -->
         ...
         <div class="border-0 card">
            <div class="p-0 mt-4 mb-3 border-0 card-header d-md-flex align-items-center d-block">
                ...
                <!-- refresh -->
                <a href="{{ route('category.trash') }}" data-bs-toggle="tooltip" data-bs-placement="bottom" class="btn top-icon-button ms-auto print-none" title="Refresh">
                    <i class="bi bi-arrow-clockwise"></i>
                </a>

                <!-- add -->
                <a href="{{ route('category.create') }}" class="btn top-icon-button print-none" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Create new project">
            ...
            <div class="p-0 card-body">
                ...
                <div class="mb-3 d-block">
                    <form action="{{ route('sub-category.trash') }}" method="POST">
                        @csrf
                                    ...
                                    @forelse($records as $key => $record)
                                        <tr>
                                            ...
                                            <td class="print-none text-end">
                                                <a href="{{ route('sub-category.restore', $record->id) }}" class="btn btn-danger table-small-button" title="Restore">
                                                    <i class="bi bi-bootstrap-reboot"></i>
                                                </a>

                                                <a href="{{ route('sub-category.permanentDelete', $record->id) }}" onclick="return confirm('Are you sure, want to delete this data permanently?')" title="Permanent delete" class="btn table-small-button text-danger">
