        ...
        <!-- container menu end -->
         ...
         <div class="border-0 card">
            <div class="p-0 mt-4 mb-3 border-0 card-header d-md-flex align-items-center d-block">
                ...
                <!-- refresh -->
                <a href="{{ route('diposit.trash') }}" data-bs-toggle="tooltip" data-bs-placement="bottom" class="btn top-icon-button ms-auto print-none" title="Refresh">
                    <i class="bi bi-arrow-clockwise"></i>
                </a>

                <!-- add -->
                <a href="{{ route('diposit.create') }}" class="btn top-icon-button print-none" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Create new account">
            ...
            <div class="p-0 card-body">
                ...
                <div class="mb-3 d-block">
                    <form action="{{ route('diposit.trash') }}" method="POST">
                        @csrf
                        ...
                        <div class="table-responsive">
                            <table class="table custom-table table-hover">
                                ...
                                <tbody>
                                    @forelse($records as $key => $diposit)
                                        <tr>
                                            <th scope="row" class="p-0">
                                                <label class="p-2 d-block">
                                                    <input type="checkbox" name="records[]" value="{{ $diposit->id }}" class="me-2">
                                            ...
                                            <td class="print-none text-end">
                                                <a href="{{ route('diposit.restore', $diposit->id) }}" class="btn btn-success table-small-button " title="Restore">
                                                    <i class="bi bi-bootstrap-reboot"></i>
                                                </a>

                                                <a href="{{ route('diposit.permanentDelete', $diposit->id) }}" onclick="return confirm('Are you sure, want to delete this data permanently?')" title="Permanent delete" class="btn table-small-button text-danger">
