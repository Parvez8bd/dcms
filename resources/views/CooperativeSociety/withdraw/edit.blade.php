    ...
    <div class="container">
        ...
        <div class="border-0 card">
            <div class="p-0 mt-4 mb-3 border-0 card-header d-flex">
                <!-- page title -->
                <div>
                    <h4 class="main-title">Edit withdraw</h4>
                    <p><small>Can Edit withdraw <strong>deposit</strong> amount from here.</small></p>
                </div>
            ...
            <div class="p-0 pt-3 card-body">
                ...
                <div class="row my-4">
                    <div class="col-md-6 ">
                        <form action="{{ route('diposit-withdraw.update',$dipositWithdraw->id) }}" method="POST">
                            @csrf
                            @method('PATCH')
                            <div class="mb-3 row">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="date" name="withdraw_date" value="{{ old('investment_date', $dipositWithdraw->withdraw_date->format("Y-m-d")) }}" class="form-control" id="investment-date" required>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-5">
                                    <div class="input-group">
                                        <input type="number" name="profit" value="{{ old('amount', $dipositWithdraw->profit ) }}" onchange="withdraw()" step="any" min="0" class="form-control" id="profit" placeholder="0.00" aria-describedby="amount-addon" required>
                                        <span class="input-group-text" id="amount-addon">TK</span>
                                    </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                @php
                                   $profit= $data->diposit->sum('amount')+$dipositWithdraw->profit;
                                @endphp

                                <div class="col-md-5">
                                    <div class="input-group">
                                        <input readonly type="number" name="profit1" value="{{ old('profit1', $profit) }}" step="any" min="0" class="form-control" id="withdrawAmount" placeholder="0.00" aria-describedby="amount-addon" required>
                                        <span class="input-group-text" id="amount-addon">TK</span>
                                    </div>
                            ...
                            <div class="mb-5 row">
                                ...
                                <div class="col-md-8">
                                    <textarea name="note" class="form-control" id="note" rows="3" placeholder="Optional">{{ old('note',$dipositWithdraw->note) }}</textarea>
                                </div>
                            </div>
