<x-app-layout>
    ...
    <div class="container">
        <div class="text-center mt-3 mb-3">
            <h3>Welcome to Diposit</h3>
        </div>
         <div>
            <h3 class="text-muted mb-2"> Diposit <i class="bi bi-wallet"></i></h3>
        </div>
					...
					<div class="card-body">
						{{-- <a href="{{route('student.index')}}" target="_blank"> --}}
							<div class="row align-items-center">
								<div class="col">
									<h6 class="mb-3 text-white">Total Diposit</h6>
										<h3 class="mb-0 text-white">{{ number_format($total_diposit,2) }}</h3>
								</div>
				...
				<div class="shadow card payment-card">
					<div class="card-body">
						{{-- <a href="{{route('student.index')}}" target="_blank"> --}}
							<div class="row align-items-center">
								<div class="col">
									<h6 class="mb-3 text-white">Today Diposit</h6>
										<h3 class="mb-0 text-white">{{ number_format($today_diposit ,2) }}</h3>
								</div>
								<div class="col-auto text-white fs-3">
							...
							<div class="row align-items-center">
								<div class="col">
									<h6 class="mb-3 text-white">last Month</h6>
										<h3 class="mb-0 text-white">{{ number_format($lastMonth_diposit,2) }}</h3>
								</div>
								<div class="col-auto text-white fs-3">
...
<!--
				...
				<div class="shadow card expance-color">
					<div class="card-body">
						{{-- <a href="{{route('payment.index')}}" target="_blank"> --}}
							<div class="row align-items-center">
								<div class="col">
									<h6 class="mb-3 text-white">Regular Diposit</h6>
	...
	<div class="container">
        <div>
            <h3 class="text-muted mb-2">Account <i class="bi bi-person-lines-fill"></i></h3>
        </div>
        <div class="mb-4 gy-3 row">
           <div class="col-xl-3 col-md-6">
				<div class="shadow card total-color">
					<div class="card-body">
						{{-- <a href="{{route('expense.index')}}" target="_blank"> --}}
							<div class="row align-items-center">
								<div class="col">
									<h6 class="mb-3 text-white">Total Account</h6>
										<h3 class="mb-0 text-white">{{ number_format($total_account)}}</h3>
								</div>
								<div class="col-auto text-white fs-3 ">
				...
				<div class="shadow card student-card">
					<div class="card-body">
						{{-- <a href="{{route('expense.index')}}?search=1&form_date={{date('Y-m-d')}}&to_date={{date('Y-m-d')}}" target="_blank"> --}}
							<div class="row align-items-center">
								<div class="col">
									<h6 class="mb-3 text-white">Fixed Diposit</h6>
										<h3 class="mb-0 text-white">{{ number_format($fixed_account)}}</h3>
								</div>
								<div class="col-auto text-white fs-3">
									<i class="bi bi-cash"></i>
								</div>
							</div>
								<p class="mt-2 text-white">Total Account</p>
						</a>
					</div>
				</div>
			</div>
					...
					<div class="card-body">
						{{-- <a href="{{route('expense-subcategory.index')}}" target="_blank"> --}}
							<div class="row align-items-center">
								<div class="col">
									<h6 class="mb-3 text-white">Regular Diposit</h6>
										<h3 class="mb-0 text-white">{{ number_format($regular_account)}}</h3>
								</div>
								<div class="col-auto text-white fs-3">
									<i class="bi bi-cash"></i>
								</div>
    ...
    <div class="container">
        ...
        <div>
            <h4 class="text-muted mb-2">Member <i class="bi bi-people-fill"></i></h4>
        </div>
        <div class="mb-4 gy-3 row">
			<div class="col-xl-3 col-md-6">
				<div class="shadow card total-color">
					<div class="card-body">
						{{-- <a href="{{route('student.index')}}?student_type=private_program" target="_blank"> --}}
							<div class="row align-items-center">
								<div class="col">
									<h6 class="mb-3 text-white">Total Member</h6>
										<h3 class="mb-0 text-white">{{ $total_member }}</h3>
